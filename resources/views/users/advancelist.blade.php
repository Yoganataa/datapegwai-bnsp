...
<div class="col-md-12 mb-3">
   <div class="stats-info border p-3">
         ...
         <div class="row">
            <div class="col-xs-4 form-inline">
               <div class="input-daterange input-group" id="datepicker">
                  ...
                  <span class="input-group-text mx-2 mt-3">to</span>
                  <input type="text" class="input-sm form-control" id="end"  name="end" value="{{ date('Y-m-t') }}"/>
               </div>
               <button type="button" id="dateSearch" class="btn btn-sm btn-primary ms-2"><i class="las la-search"></i></button>
               <button type="button" id="refresh" class="btn btn-sm btn-primary ms-2"><i class="las la-redo-alt"></i></button>
            </div>
         </div>
      </div>
