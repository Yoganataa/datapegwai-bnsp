   ...
   <div class="panel panel-default">
         ...
         <div class="row">
            <div class="col-xs-4 form-inline">
               <div class="input-daterange input-group" id="datepicker">
                  <input type="text" class="form-control form-control-sm" id="start" name="start" value="{{ date('Y-m-01') }}"/>
                  <span class="input-group-text mt-3 ml-2 mr-2">to</span>
                  <input type="text" class="form-control form-control-sm" id="end"  name="end" value="{{ date('Y-m-t') }}"/>
               </div>
      ...
      <div class="panel-body mt-3">
         <div class="table-responsive">
            <table class="table table-striped table-bordered data-table" id="try">
               <thead>
                  <tr>
                     <th>#</th>
